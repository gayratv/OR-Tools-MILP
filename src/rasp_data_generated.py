...
def create_timetable_data() -> InputData:
    ...
    split_subjects = {'INFORMATIKA I IKT', 'TEKhNOLOGIYa', 'INOSTRANNYY YaZYK'}
    subgroup_ids = [1, 2]
    ...
    subgroup_plan_hours = {   ('5A', 'INFORMATIKA I IKT', 1): 2,
    ('5A', 'INFORMATIKA I IKT', 2): 2,
    ('5A', 'INOSTRANNYY YaZYK', 1): 3,
    ('5A', 'INOSTRANNYY YaZYK', 2): 3,
    ('5A', 'TEKhNOLOGIYa', 1): 2,
    ('5A', 'TEKhNOLOGIYa', 2): 2,
    ('5B', 'INFORMATIKA I IKT', 1): 2,
    ('5B', 'INFORMATIKA I IKT', 2): 2,
    ...
    # --- Ограничения ---
    days_off = {'SINYaVINA N.A.': {'Tue', 'Mon'}}
