...
class OptimizationWeights:
    ...
    """
    alpha_runs: float = 10.0   # анти-окна: минимизация числа блоков занятий
    alpha_runs_teacher: float = 2.0   # анти-окна: минимизация числа блоков занятий для учителей
    ...
    epsilon_pairing: float = 20.0 # штраф за каждый "одиночный" урок, который должен быть спарен
