...
/*!50032 DROP TRIGGER IF EXISTS core_users_ai */;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `core_users_ai` AFTER INSERT ON `core_users` FOR EACH ROW BEGIN
...
-- Dump completed on 2025-10-07 18:46:02
