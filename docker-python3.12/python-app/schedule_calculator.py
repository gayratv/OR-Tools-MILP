...
def build_and_solve_with_or_tools(
    ...
    weights = get_default_optimization_weights()
    ...
    if status in (cp_model.OPTIMAL, cp_model.FEASIBLE):
        ...
        total_teacher_windows = calculate_teacher_windows(data, solver, x, z)
...
if __name__ == '__main__':
    ...
    if data_source == 'db':
        ...
        loaded_data = create_manual_data()
